...
import ltd.matrixstudios.bukkit.utils.menu.MenuController
import ltd.matrixstudios.bukkit.utils.menu.navigation.PageNavigationMenu
...
abstract class PaginatedMenu(
    ...
    fun updateMenu() {
        ...
        println("Menu ${this::class.java.simpleName} took ${System.currentTimeMillis() - startingTime}ms to open")
    }
